...
TextStyle text16Medium393 =
    TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: color393);

TextStyle text18Semi393 =
    TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: color393);

TextStyle text24Medium =
    TextStyle(fontSize: 24, fontWeight: FontWeight.w500, color: color332);

TextStyle text24BoldGreen =
    TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: btnColor);

TextStyle text24Medium393 =
    TextStyle(fontSize: 24, fontWeight: FontWeight.w500, color: color393);

TextStyle text14Semibold =
    TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: colorABAB);
